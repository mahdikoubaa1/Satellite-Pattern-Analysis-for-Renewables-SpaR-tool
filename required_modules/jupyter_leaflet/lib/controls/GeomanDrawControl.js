    ...
    create_obj() {
        this.feature_group_r = L.geoJson([], {
            ...
            pointToLayer: function (feature, latlng) {
                ...
                switch (feature.properties.type) {
                    ...
                    case 'circle':
                        return new L.Circle(latlng, feature.properties.style.radius, feature.properties.options);
                    case 'circlemarker':
        ...
        this.listenTo(this.model, 'change:newpolygon', () => {
            ...
            if ('properties' in newpolygon && 'label' in newpolygon.properties) {
                if (newpolygon.properties.label == 0)
                    this.feature_group_b.addData(newpolygon);
                else {
        ...
        this.map_view.obj.on('pm:create', (e) => {
            ...
            if (layer instanceof L.Polygon && layer.options.color == 'red') {
                ...
                this.feature_group_b.addLayer(layer);
            this.layers_to_data();
            this.model.save_changes();
        });
        this.map_view.obj.on('pm:remove', (e) => {
            ...
            else if (eventLayer instanceof L.Polygon && eventLayer.options.color == 'blue')
                this.feature_group_b.removeLayer(eventLayer);
            this.send({
                event: 'pm:remove',
        ...
        this.map_view.obj.on('pm:cut', (e) => {
            ...
            if (eventLayer instanceof L.Polygon && eventLayer.options.color == 'red')
                this.feature_group_r.addLayer(eventLayer);
            else if (eventLayer instanceof L.Polygon && eventLayer.options.color == 'blue')
                this.feature_group_b.addLayer(eventLayer);
